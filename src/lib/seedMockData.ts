...
const MENU_ITEMS = [
    ...
    { name: 'Beef Burger', description: 'Premium succulent beef patty grilled to perfection, stacked with a delicious slice of cheese and fresh veggies.', price: 3000.00, categoryName: 'Burgers', image: 'https://res.cloudinary.com/dat1l3gbi/image/upload/v1772415990/burger-house/vfryioj61yb2igehf1bh.png' },
